...
namespace BookingService.Infrastructure.Read
{
	public class BookingDbContextRead : DbContext
	{
		public BookingDbContextRead(DbContextOptions<BookingDbContextRead> options) : base(options)
		{
		}
