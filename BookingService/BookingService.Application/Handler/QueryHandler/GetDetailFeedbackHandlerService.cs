...
{
	public class GetDetailFeedbackHandlerService : IRequestHandler<GetDetailFeedbackQuery, FeedbackResponse>
	{
		private readonly IFeedbackRepositoryRead _repo;

		public GetDetailFeedbackHandlerService(IFeedbackRepositoryRead repo)
		{
			_repo = repo;
		}
