...
{
	public class GetBookingByLawyerAndStatusHandler : IRequestHandler<GetBookingByLawyerAndStatusQuery, List<BookingDetailResponse>>
	{
		private readonly IBookingRepositoryRead _bookingRepository;
		private readonly ISlotRepositoryRead _slot;
		private readonly IEventPublisher _eventPublisher;
		public GetBookingByLawyerAndStatusHandler(IBookingRepositoryRead bookingRepository, ISlotRepositoryRead slot, IEventPublisher eventPublisher)
		{
		...
		{
			var bookings = await _bookingRepository.GetBookingsByLawyerIdAndStatus(request.LawyerId, request.Status,request.BookingDate);
