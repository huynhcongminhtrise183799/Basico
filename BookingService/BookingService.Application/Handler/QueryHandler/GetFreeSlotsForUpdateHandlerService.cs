...
{
	public class GetFreeSlotsForUpdateHandlerService : IRequestHandler<GetFreeSlotsForUpdateQuery, List<Slot>>
	{
		private readonly ISlotRepositoryRead _slotRepositoryRead;
		//private readonly IEventPublisher _publishEndpoint;
		private readonly IClientFactory _clientFactory;

		public GetFreeSlotsForUpdateHandlerService(ISlotRepositoryRead slotRepositoryRead, IClientFactory clientFactory)
		{
