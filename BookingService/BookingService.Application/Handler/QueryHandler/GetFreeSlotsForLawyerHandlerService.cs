...
{
	public class GetFreeSlotsForLawyerHandlerService : IRequestHandler<GetFreeSlotsForLawyerQuery, List<Slot>>
	{
		private readonly ISlotRepositoryRead _slotRepositoryRead;
		//private readonly IEventPublisher _publishEndpoint;
		private readonly IClientFactory _clientFactory;

		public GetFreeSlotsForLawyerHandlerService(ISlotRepositoryRead slotRepositoryRead, IClientFactory clientFactory)
		{
