...
{
	public class UpdateBookingHandlerService : IRequestHandler<UpdateBookingCommand, bool>
	{
		...
		public UpdateBookingHandlerService(IBookingRepositoryWrite bookingRepositoryWrite, IBookingSlotsRepositoryWrite bookingSlotsRepositoryWrite, IPublishEndpoint publish)
		{
