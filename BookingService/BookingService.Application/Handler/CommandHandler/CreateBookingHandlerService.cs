...
{
    public class CreateBookingHandlerService : IRequestHandler<CreateBookingCommand, BookingResponse>
    {
        private readonly IBookingRepositoryWrite _bookingRepository;
        private readonly IPublishEndpoint _publish;

        public CreateBookingHandlerService(IBookingRepositoryWrite bookingRepository, IPublishEndpoint publishEndpoint)
        {
