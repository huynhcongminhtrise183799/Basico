...
{
	public class CheckOutBookingHandler : IRequestHandler<CheckOutBookingCommand, bool>
	{
		private readonly IBookingRepositoryWrite _repoWrite;
		private readonly IPublishEndpoint _publish;
		public CheckOutBookingHandler(IBookingRepositoryWrite repoWrite, IPublishEndpoint publish)
		{
