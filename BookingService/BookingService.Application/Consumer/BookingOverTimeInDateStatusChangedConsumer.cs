...
{
    public class BookingOverTimeInDateStatusChangedConsumer : IConsumer<BookingOverTimeInDateStatusChangedEvent>
    {
        private readonly IBookingRepositoryRead _repository;

        public BookingOverTimeInDateStatusChangedConsumer(IBookingRepositoryRead repository)
        {
