...
{
	public class BookingOverTimeStatusChangedConsumer : IConsumer<BookingOverTimeStatusChangedEvent>
	{
		private readonly IBookingRepositoryRead _repository;

		public BookingOverTimeStatusChangedConsumer(IBookingRepositoryRead repository)
		{
