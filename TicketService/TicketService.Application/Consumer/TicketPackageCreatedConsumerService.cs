...
{
    public class TicketPackageCreatedConsumerService : IConsumer<TicketPackageCreatedEvent>
    {
        private readonly ITicketPackageRepositoryRead _repo;
        public TicketPackageCreatedConsumerService(ITicketPackageRepositoryRead repo)
        {
            _repo = repo ;
        }
