...
{
    public class ReplyTicketCommandHandler : IRequestHandler<ReplyTicketCommand, bool>
    {
        private readonly ITicketRepositoryWrite _repoWrite;
        private readonly IPublishEndpoint _publish;
        public ReplyTicketCommandHandler(ITicketRepositoryWrite repoWrite, IPublishEndpoint publishEndpoint)
        {
        ...
        public async Task<bool> Handle(ReplyTicketCommand request, CancellationToken cancellationToken)
        {
           ...
           await _repoWrite.ReplyTicket(ticket);
