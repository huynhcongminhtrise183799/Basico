...
{
    public class GetTicketsByStatusQueryHandler : IRequestHandler<GetTicketsByStatusQuery, IEnumerable<Domain.Entities.Ticket>>
    {
        private readonly ITicketRepositoryRead _repository;

        public GetTicketsByStatusQueryHandler(ITicketRepositoryRead repository)
        {
