...
{
    public class DeleteTicketPackageCommandHandlerService : IRequestHandler<DeleteTicketPackageCommand, bool>
    {
        private readonly ITicketPackageRepositoryWrite _repo;
        private readonly IPublishEndpoint _publish;

        public DeleteTicketPackageCommandHandlerService(ITicketPackageRepositoryWrite repo, IPublishEndpoint publishEndpoint)
        {
            _repo = repo;
