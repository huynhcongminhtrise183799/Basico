...
{
    public class CreateTicketPackageCommandHandler : IRequestHandler<CreateTicketPackageCommand, TicketPackageResponse>
    {
        private readonly ITicketPackageRepositoryWrite _repo;
        private readonly IPublishEndpoint _publish;
        public CreateTicketPackageCommandHandler(ITicketPackageRepositoryWrite repo, IPublishEndpoint publishEndpoint)
        {
            _repo = repo;
