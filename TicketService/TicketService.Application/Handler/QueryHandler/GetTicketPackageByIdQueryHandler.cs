...
{
    public class GetTicketPackageByIdQueryHandler : IRequestHandler<GetTicketPackageByIdQuery, TicketPackageResponse>
    {
        private readonly ITicketPackageRepositoryRead _repo;
        public GetTicketPackageByIdQueryHandler(ITicketPackageRepositoryRead repo)
        {
            _repo = repo;
        }
