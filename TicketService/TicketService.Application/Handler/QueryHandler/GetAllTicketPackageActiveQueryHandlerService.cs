...
{
    public class GetAllTicketPackageActiveQueryHandlerService : IRequestHandler<GetAllTicketPackageActiveQuery, List<TicketPackageResponse>>
    {
        private readonly ITicketPackageRepositoryRead _repo;
        public GetAllTicketPackageActiveQueryHandlerService(ITicketPackageRepositoryRead repo)
        {
            _repo = repo;
        }
        public async Task<List<TicketPackageResponse>> Handle(GetAllTicketPackageActiveQuery request, CancellationToken cancellationToken)
        {
