...
{
    public class GetAllTicketPackageQueryHandler : IRequestHandler<GetAllTicketPackageQuery, List<TicketPackageResponse>>
    {
        private readonly ITicketPackageRepositoryRead _repo;
        public GetAllTicketPackageQueryHandler(ITicketPackageRepositoryRead repo)
        {
            _repo = repo;
        }
