...
{
    public class GetTicketPackagesPagitionQueryHandlerService : IRequestHandler<GetTicketPackagesPagitionQuery, List<TicketPackageResponse>>
    {
        private readonly ITicketPackageRepositoryRead _repo;
        public GetTicketPackagesPagitionQueryHandlerService(ITicketPackageRepositoryRead repo)
        {
            _repo = repo;
        }
