...
{
    public class GetAllTicketPackageActiveQueryHandler : IRequestHandler<GetAllTicketPackageActiveQuery, List<TicketPackageResponse>>
    {
        private readonly ITicketPackageRepositoryRead _repo;
        public GetAllTicketPackageActiveQueryHandler(ITicketPackageRepositoryRead repo)
        {
            _repo = repo;
        }
