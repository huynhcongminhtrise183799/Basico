...
{
	public class GetRevenueByDateQueryHandler : IRequestHandler<GetRevenueByDateQuery, List<RevenueResponse>>
	{
		private readonly IPaymentRepositoryRead _paymentRepository;
		public GetRevenueByDateQueryHandler(IPaymentRepositoryRead paymentRepository)
		{
