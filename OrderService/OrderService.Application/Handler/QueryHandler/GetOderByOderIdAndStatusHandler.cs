...
{
	public class GetOderByOderIdAndStatusHandler : IRequestHandler<GetOderByOderIdAndStatusQuery, Order?>
	{
		private readonly IOrderRepositoryRead _repoRead;

		public GetOderByOderIdAndStatusHandler(IOrderRepositoryRead repoRead)
		{
			_repoRead = repoRead;
		}
