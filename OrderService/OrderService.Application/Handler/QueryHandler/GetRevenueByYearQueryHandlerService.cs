...
{
	public class GetRevenueByYearQueryHandlerService : IRequestHandler<GetRevenueByYearQuery, List<RevenueResponse>>
	{
		private readonly IPaymentRepositoryRead _paymentRepository;

		public GetRevenueByYearQueryHandlerService(IPaymentRepositoryRead paymentRepository)
		{
