...
{
	public class CancelPaymentCommandHandlerService : IRequestHandler<CancelPaymentCommand, bool>
	{
		private readonly IOrderRepositoryWrite _orderRepository;
		private readonly IPublishEndpoint _publishEndpoint;
		public CancelPaymentCommandHandlerService(IOrderRepositoryWrite orderRepository, IPublishEndpoint publishEndpoint)
		{
