...
{
	public class CreatePaymentCommandHandlerService : IRequestHandler<CreatePaymentCommand, string>
	{
		...
		public CreatePaymentCommandHandlerService(IPaymentRepositoryWrite repoWrite, IPublishEndpoint publishEndpoint, IOrderRepositoryRead orderRepositoryRead1, IClientFactory clientFactory)
		{
