...
{
    public class CreateOrderCommandHandlerService : IRequestHandler<CreateOrderCommand, Guid>
    {
        private readonly IOrderRepositoryWrite _orderRepository;
		private readonly IPublishEndpoint _publishEndpoint;
		public CreateOrderCommandHandlerService(IOrderRepositoryWrite orderRepository, IPublishEndpoint publishEndpoint)
        {
