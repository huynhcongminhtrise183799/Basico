...
{
    public class OrderCreatedEventConsumerService : IConsumer<OrderTicketPackageCreatedEvent>
    {
        private readonly IOrderRepositoryRead _dbContextWrite;

        public OrderCreatedEventConsumerService(IOrderRepositoryRead dbContextWrite)
        {
