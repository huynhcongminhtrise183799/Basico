...
{
	public class UpdateOrderStatusConsumerService : IConsumer<UpdateOrderStatusEvent>
	{
		private readonly IOrderRepositoryRead _repoRead;
		private readonly IOrderRepositoryWrite _repoWrite;
		public UpdateOrderStatusConsumerService(IOrderRepositoryRead repoRead, IOrderRepositoryWrite repoWrite)
		{
			_repoRead = repoRead;
