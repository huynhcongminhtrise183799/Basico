...
{
    public class FormTemplateCreatedConsumerService : IConsumer<FormTemplateCreatedEvent>
    {
        private readonly IFormTemplateRepositoryRead _repo;

        public FormTemplateCreatedConsumerService(IFormTemplateRepositoryRead repo)
        {
            _repo = repo;
        }
