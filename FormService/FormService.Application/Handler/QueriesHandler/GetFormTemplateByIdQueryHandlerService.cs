...
{
    public class GetFormTemplateByIdQueryHandlerService : IRequestHandler<GetFormTemplateByIdQuery, FormTemplateResponse>
    {
        private readonly IFormTemplateRepositoryRead _repo;
        public GetFormTemplateByIdQueryHandlerService(IFormTemplateRepositoryRead repo)
        {
            _repo = repo;
        }
