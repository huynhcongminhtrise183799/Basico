...
{
    public class GetFormTemplatesPagitionQueryHandler : IRequestHandler<GetFormTemplatesPagitionQuery, List<FormTemplateResponse>>
    {
        private readonly IFormTemplateRepositoryRead _repo;
        public GetFormTemplatesPagitionQueryHandler(IFormTemplateRepositoryRead repo)
        {
            _repo = repo;
        }
