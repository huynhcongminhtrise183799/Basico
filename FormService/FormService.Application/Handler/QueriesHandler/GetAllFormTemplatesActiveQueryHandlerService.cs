...
{
    public class GetAllFormTemplatesActiveQueryHandlerService : IRequestHandler<GetAllFormTemplatesActiveQuery, List<FormTemplateResponse>>
    {
        private readonly IFormTemplateRepositoryRead _formTemplateRepositoryRead;
        public GetAllFormTemplatesActiveQueryHandlerService(IFormTemplateRepositoryRead formTemplateRepositoryRead)
        {
