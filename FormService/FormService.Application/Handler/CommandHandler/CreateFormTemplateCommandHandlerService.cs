...
{
    public class CreateFormTemplateCommandHandlerService : IRequestHandler<CreateFormTemplateCommand, FormTemplateResponse>
    {
        private readonly IFormTemplateRepositoryWrite _formTemplateRepositoryWrite;
        private readonly IPublishEndpoint _publishEndpoint;

        public CreateFormTemplateCommandHandlerService(IFormTemplateRepositoryWrite formTemplateRepositoryWrite, IPublishEndpoint publishEndpoint)
        {
