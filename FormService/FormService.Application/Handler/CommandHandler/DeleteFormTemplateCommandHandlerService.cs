...
{
    public class DeleteFormTemplateCommandHandlerService : IRequestHandler<DeleteFormTemplateCommand, bool>
    {
        private readonly IFormTemplateRepositoryWrite _formTemplateRepositoryWrite;
        private readonly IPublishEndpoint _publishEndpoint;
        public DeleteFormTemplateCommandHandlerService(IFormTemplateRepositoryWrite formTemplateRepositoryWrite, IPublishEndpoint publishEndpoint)
        {
