...
{
	public class UpdateCustomerFormHandler : IRequestHandler<UpdateCustomerFormCommand, bool>
	{
		private readonly IFormDataRepositoryWrite _repoWrite;
		private readonly IPublishEndpoint _publishEndpoint;
		public UpdateCustomerFormHandler(IFormDataRepositoryWrite repoWrite, IPublishEndpoint publishEndpoint)
		{
