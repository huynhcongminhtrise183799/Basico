...
{
	public class DayOffUpdatedConsumerService : IConsumer<DayOffUpdatedEvent>
	{
		...
		public DayOffUpdatedConsumerService(ILawyerDayOffScheduleRepositoryRead repoRead, ISpecificDayOffRepositoryRead specificDayOffRepositoryRead)
		{
			_repoRead = repoRead;
