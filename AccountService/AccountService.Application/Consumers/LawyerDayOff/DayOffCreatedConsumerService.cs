...
{
	public class DayOffCreatedConsumerService : IConsumer<DayOffCreatedEvent>
	{
		...
		public DayOffCreatedConsumerService(ILawyerDayOffScheduleRepositoryRead repoRead, ISpecificDayOffRepositoryRead specificDayOffRepositoryRead)
		{
			_repoRead = repoRead;
