...
{
	public class DayOffDeletedConsumer : IConsumer<DayOffDeletedEvent>
	{
		...
		public DayOffDeletedConsumer(ILawyerDayOffScheduleRepositoryRead repoRead, ISpecificDayOffRepositoryRead specificDayOffRepositoryRead)
		{
			_repoRead = repoRead;
