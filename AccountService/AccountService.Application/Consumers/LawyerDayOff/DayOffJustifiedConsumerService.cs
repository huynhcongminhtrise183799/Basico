...
{
	public class DayOffJustifiedConsumerService : IConsumer<DayOffJustifiedEvent>
	{
		private readonly ISpecificDayOffRepositoryRead _repoRead;

		public DayOffJustifiedConsumerService(ISpecificDayOffRepositoryRead repoRead)
		{
			_repoRead = repoRead;
		}
