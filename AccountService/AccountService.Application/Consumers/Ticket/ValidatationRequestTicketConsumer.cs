...
{
    public class ValidatationRequestTicketConsumer : IConsumer<ValidatationRequestTicket>
    {
        private readonly IAccountRepositoryRead _repoRead;

        public ValidatationRequestTicketConsumer(IAccountRepositoryRead repoRead)
        {
            _repoRead = repoRead;
        }
