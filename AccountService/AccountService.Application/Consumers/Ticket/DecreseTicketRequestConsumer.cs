...
{
    public class DecreseTicketRequestConsumer : IConsumer<DecreseTicketRequestEvent>
    {
        private readonly IAccountRepositoryWrite _accountWriteRepo;
        private readonly IAccountRepositoryRead _accountReadRepo;

        public DecreseTicketRequestConsumer(IAccountRepositoryWrite accountWriteRepo, IAccountRepositoryRead accountReadRepo)
        {
