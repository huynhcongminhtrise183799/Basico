...
{
	public class GetDetailBookingInformationConsumerService : IConsumer<GetDetailBookingInformation>
	{
		private readonly IAccountRepositoryRead _accountRead;
		private readonly IServiceRepositoryRead _serviceRead;

		public GetDetailBookingInformationConsumerService(IAccountRepositoryRead accountRead, IServiceRepositoryRead serviceRead)
		{
