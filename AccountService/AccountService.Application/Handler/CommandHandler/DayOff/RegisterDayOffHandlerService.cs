...
{
	public class RegisterDayOffHandlerService : IRequestHandler<RegisterDayOffCommand, RegisterDayOffResponse>
	{
		...
		public RegisterDayOffHandlerService(ILawyerDayOffScheduleRepositoryWrite repoWrite, ISpecificDayOffRepositoryWrite specificWrite, IPublishEndpoint publish)
		{
