...
{
	public class JustifyDayOffHandler : IRequestHandler<JustifyDayOffCommand, bool>
	{
		private readonly ISpecificDayOffRepositoryWrite _repoWrite;
		private readonly IPublishEndpoint _publish;
		public JustifyDayOffHandler(ISpecificDayOffRepositoryWrite repoWrite, IPublishEndpoint publish)
		{
