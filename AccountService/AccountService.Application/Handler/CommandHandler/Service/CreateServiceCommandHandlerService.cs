...
{
    public class CreateServiceCommandHandlerService : IRequestHandler<CreateServiceCommand, Guid>
    {
        private readonly IAccountRepositoryWrite _repository;
        private readonly IPublishEndpoint _publishEndpoint;

        public CreateServiceCommandHandlerService(IAccountRepositoryWrite repository, IPublishEndpoint publishEndpoint)
        {
