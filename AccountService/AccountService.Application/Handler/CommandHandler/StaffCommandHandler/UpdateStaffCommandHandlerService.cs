...
{
    public class UpdateStaffCommandHandlerService : IRequestHandler<UpdateStaffCommand, bool>
    {
        private readonly IAccountRepositoryWrite _repoWrite;
        private readonly IPublishEndpoint _publishEndpoint;

		public UpdateStaffCommandHandlerService(IAccountRepositoryWrite repoWrite, IPublishEndpoint publishEndpoint)
        {
