...
{
    public class DeleteStaffCommandHandlerService : IRequestHandler<DeleteStaffCommand, bool>
    {
        private readonly IAccountRepositoryWrite _repoWrite;
        private readonly IPublishEndpoint _publishEndpoint;

		public DeleteStaffCommandHandlerService(IAccountRepositoryWrite repoWrite, IPublishEndpoint publishEndpoint)
        {
