...
{
    public class LoginUserCommandHandlerService : IRequestHandler<LoginUserCommand, string>
    {
        private readonly ITokenService _tokenService;
        private readonly IAccountRepositoryRead _accountRepository;

        public LoginUserCommandHandlerService(ITokenService tokenService, IAccountRepositoryRead accountRepository)
        {
