...
{
	public class ActiveAccountCommandHandler : IRequestHandler<ActiveUserAccountCommand, bool>
	{
		private readonly IAccountRepositoryWrite _repoWrite;
		private readonly IPublishEndpoint _publish;
		public ActiveAccountCommandHandler(IAccountRepositoryWrite repoWrite, IPublishEndpoint publish)
		{
