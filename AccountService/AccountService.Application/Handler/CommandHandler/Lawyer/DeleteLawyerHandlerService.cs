...
{
    public class DeleteLawyerHandlerService : IRequestHandler<DeleteLawyerCommand>
    {
        private readonly IAccountRepositoryWrite _accountRepository;
        private readonly IPublishEndpoint _publishEndpoint;

        public DeleteLawyerHandlerService(IAccountRepositoryWrite accountRepository, IPublishEndpoint publishEndpoint)
        {
