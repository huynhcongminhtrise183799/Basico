...
{
	public class ResetPasswordCommandHandlerService : IRequestHandler<ResetPasswordCommand, bool>
	{
		private readonly IAccountRepositoryWrite _repoWrite;
		private readonly IPublishEndpoint _publishEndpoint;

		public ResetPasswordCommandHandlerService(IAccountRepositoryWrite repoWrite, IPublishEndpoint publishEndpoint)
		{
