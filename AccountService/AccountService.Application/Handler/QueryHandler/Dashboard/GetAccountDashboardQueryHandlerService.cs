...
{
	public class GetAccountDashboardQueryHandlerService : IRequestHandler<GetAccountDashboardQuery, AccountDashboardResponse>
	{
		private readonly IAccountRepositoryRead _repository;

		public GetAccountDashboardQueryHandlerService(IAccountRepositoryRead repository)
		{
