...
{
    public class GetAllActiveLawyerAccountsHandlerService : IRequestHandler<GetAllActiveLawyerAccountsQuery, List<Account>>
    {
        private readonly IAccountRepositoryRead _repository;

        public GetAllActiveLawyerAccountsHandlerService(IAccountRepositoryRead repository)
        {
