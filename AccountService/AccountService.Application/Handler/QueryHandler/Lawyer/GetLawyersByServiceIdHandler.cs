...
{
	public class GetLawyersByServiceIdHandler : IRequestHandler<GetLawyersByServiceIdQuery, List<LawyerWithServiceResponse>>
	{
		private readonly IAccountRepositoryRead _repository;
		public GetLawyersByServiceIdHandler(IAccountRepositoryRead repository)
		{
