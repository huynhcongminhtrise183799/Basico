...
{
    public class GetLawyerByIdHandlerService : IRequestHandler<GetLawyerByIdQuery, LawyerDto>
    {
        private readonly IAccountRepositoryRead _accountRepository;

        public GetLawyerByIdHandlerService(IAccountRepositoryRead accountRepository)
        {
