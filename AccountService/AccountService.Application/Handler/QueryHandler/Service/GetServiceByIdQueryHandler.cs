...
{
    public class GetServiceByIdQueryHandler : IRequestHandler<GetServiceByIdQuery, Domain.Entity.Service>
    {
        private readonly IAccountRepositoryRead _repository;

        public GetServiceByIdQueryHandler(IAccountRepositoryRead repository)
        {
