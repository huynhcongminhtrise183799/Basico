...
{
    public class GetAllServicesQueryHandler : IRequestHandler<GetAllServicesQuery, IEnumerable<Domain.Entity.Service>>
    {
        private readonly IAccountRepositoryRead _repository;

        public GetAllServicesQueryHandler(IAccountRepositoryRead repository)
        {
