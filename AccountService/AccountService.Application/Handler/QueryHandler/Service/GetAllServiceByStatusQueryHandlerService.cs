...
{
    public class GetAllServiceByStatusQueryHandlerService : IRequestHandler<GetAllServiceByStatusQuery, List<ServiceResponseDTO>>
	{
		private readonly IServiceRepositoryRead _repository;

		public GetAllServiceByStatusQueryHandlerService(IServiceRepositoryRead repository)
		{
