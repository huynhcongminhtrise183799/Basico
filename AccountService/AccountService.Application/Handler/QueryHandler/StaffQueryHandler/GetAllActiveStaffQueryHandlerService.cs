...
{
	public class GetAllActiveStaffQueryHandlerService : IRequestHandler<GetAllActiveStaffQuery, List<StaffResponse>>
	{
		private readonly IAccountRepositoryRead _repoRead;

		public GetAllActiveStaffQueryHandlerService(IAccountRepositoryRead repoRead)
		{
			_repoRead = repoRead;
		}
