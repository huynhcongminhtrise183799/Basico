...
{
	public class GetStaffByIdQueryHandlerService : IRequestHandler<GetStaffByIdQuery, StaffResponse?>
	{
		private readonly IAccountRepositoryRead _repoRead;

		public GetStaffByIdQueryHandlerService(IAccountRepositoryRead repoRead)
		{
			_repoRead = repoRead;
		}
