...
{
    public class GetAllStaffQueryHandlerService : IRequestHandler<GetAllStaffQuery, List<StaffResponse>>
    {
        private readonly IAccountRepositoryRead _repoRead;

        public GetAllStaffQueryHandlerService(IAccountRepositoryRead repoRead)
        {
            _repoRead = repoRead;
        }
