...
{
	public class DeleteDayOffHandlerService : IRequestHandler<DeleteDayOffCommand, bool>
	{
		...
		public DeleteDayOffHandlerService(ILawyerDayOffScheduleRepositoryWrite repoWrite, ISpecificDayOffRepositoryWrite specificDayOffRepositoryWrite, IPublishEndpoint publish)
		{
