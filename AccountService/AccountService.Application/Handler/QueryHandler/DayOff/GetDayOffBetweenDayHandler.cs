...
{
	public class GetDayOffBetweenDayHandler : IRequestHandler<GetDayOffsBetween, List<DayOffResponse>>
	{
		private readonly ILawyerDayOffScheduleRepositoryRead _repoRead;
		private readonly IAccountRepositoryRead _accountRepoRead;

		public GetDayOffBetweenDayHandler(ILawyerDayOffScheduleRepositoryRead repoRead, IAccountRepositoryRead accountRepoRead)
		{
			_repoRead = repoRead;
