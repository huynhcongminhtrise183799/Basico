...
{
	public class GetDetailDayOffHandler : IRequestHandler<GetDetailDayOffQuery, DayOffResponse>
	{
		private readonly ILawyerDayOffScheduleRepositoryRead _repoRead;

		public GetDetailDayOffHandler(ILawyerDayOffScheduleRepositoryRead repoRead)
		{
			_repoRead = repoRead;
		}
