...
{
	public class GetAllAccountQueryHandler : IRequestHandler<GetAllAccountQuery, List<AccountResponse>>
	{
		private readonly IAccountRepositoryRead _repoRead;

		public GetAllAccountQueryHandler(IAccountRepositoryRead repoRead)
		{
			_repoRead = repoRead;
		}
