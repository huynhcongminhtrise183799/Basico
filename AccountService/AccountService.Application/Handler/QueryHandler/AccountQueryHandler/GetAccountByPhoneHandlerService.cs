...
{
	public class GetAccountByPhoneHandlerService : IRequestHandler<GetAccountByPhoneQuery, AccountResponse>
	{
		private readonly IAccountRepositoryRead _accountRepositoryRead;

		public GetAccountByPhoneHandlerService(IAccountRepositoryRead accountRepositoryRead)
		{
